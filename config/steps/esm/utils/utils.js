// const fs = require('fs');
// useful stuff
export const inherits = function (cls, superCtor, statics, prototype) {    // eslint-disable-next-line no-underscore-dangle
...
// fs{    //   exists(path) {    //     return new Promise(resolve =>{    //       fs.access(path, fs.constants.F_OK, err =>{    //         resolve(!err);
//       });
//     });
//   },
// },
...
export const range = function* (start, stop, step = 1) {
...
export const objectFromProps = (props, value = null) => {        // *Note*: Using `reduce` as `Object.fromEntries` requires Node 12+;
