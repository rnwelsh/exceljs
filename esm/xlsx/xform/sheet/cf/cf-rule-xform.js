...
class CfRuleXform extends CompositeXform {
  ...
  createNewModel({ atts }) {
    return {
      ...opType(atts),
      dxfId: BaseXform.toIntValue(atts.dxfId),
      priority: BaseXform.toIntValue(atts.priority),
      timePeriod: atts.timePeriod,
      percent: BaseXform.toBoolValue(atts.percent),
      bottom: BaseXform.toBoolValue(atts.bottom),
      rank: BaseXform.toIntValue(atts.rank),
      aboveAverage: BaseXform.toBoolValue(atts.aboveAverage),
    }
  }
