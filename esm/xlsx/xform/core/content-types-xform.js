...
class ContentTypesXform extends BaseXform {
  ...
  render(xmlStream, model) {
    ...
    xmlStream.oN('Types', ContentTypesXform.PROPERTY_ATTRIBUTES)
    const mediaHash = {};
    (model.media || []).forEach(medium => {
      if (medium.type === 'image') {
        ...
        if (!mediaHash[imageType]) {
          ...
          xmlStream.lN('Default', { Extension: imageType, ContentType: `image/${imageType}` })
        }
      }
    })
    xmlStream.lN('Default', {
      Extension: 'rels',
      ContentType: 'application/vnd.openxmlformats-package.relationships+xml',
    })
    xmlStream.lN('Default', { Extension: 'xml', ContentType: 'application/xml' })
    xmlStream.lN('Override', {
