...
import { OfficeDocument, CoreProperties, ExtenderProperties, Styles, Theme, SharedStrings as _SharedStrings, Worksheet } from '../../xlsx/rel-type.js'
...
class WorkbookWriter {
  constructor(options) {
    ...
    if (options.stream) {
      ...
      this.stream = createWriteStream(options.filename);
    } else {
